...
ResizeLongestSide::ResizeLongestSide(int target_length) : target_length_(target_length) {}

std::pair<int, int> ResizeLongestSide::get_preprocess_shape(int oldh, int oldw) const {
    double scale = static_cast<double>(target_length_) / std::max(oldh, oldw);
